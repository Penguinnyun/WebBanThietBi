        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <form method="POST" class="form-inline">
                    <input type="text" name="txtsearch" class="form-control" placeholder="Tìm kiếm tài khoản">
                    <button type="submit" name="btnsearch" class="btn btn-primary">Tìm Kiếm</button>
                </form>
                <div class="pull-right">
                    <a href="themtaikhoan.php?tentaikhoan=<?php echo $tentaikhoan ?>" class="btn btn-primary">THÊM TÀI KHOẢN</a>
                </div>
            </div>
            <div class="panel-body">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {//Vòng lặp lấy dữ liệu từ sql cho vào table
                            ...
                            <tr>
                                <td class="text-center">' . $i . '</td>
                                    ...
                                    <td class="text-center"> ' . $row["loaitaikhoan"] . ' </td>
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="xoataikhoan.php?id=' . $row["tentaikhoan"] .'&tentaikhoan=' . $tentaikhoan . '" class="btn btn-danger btn-xs" title="Delete" data-toggle="tooltip" onclick="return confirm(\'Có chắc chắn muốn xoá?\');">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btnsearch'])) {
                    ...
                    if (empty($timkiem)) {
                        ...
                        echo '<a href="taikhoan.php?tentaikhoan=' . $tentaikhoan . '" class="quaylaithongtin">Quay lại bảng thông tin</a>';
                    echo '
                    <script>
